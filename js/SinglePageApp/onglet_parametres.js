...
parametres_p.addCssClass("corps_parametres");
	...
	partieG.setWidth(30);
		...
		content_titre_CI.setContent("<h2>"+_("Centres d'interet")+"</h2>");
		...
		options_liste_CI.setContent('<ul>'+
										'<li id="ajouter_CI" class="bouton_option showPopup" popup="popup_nouveau_CI"><a href="#">'+_("Nouveau centre d'intérêt")+'</a></li>'+
										'</ul>');
			...
			popup_nouveau_CI.setHeight('200px');
				...
				var content_nouveau_CI = popup_nouveau_CI.newVerticalLayout();
					...
					titre_popup_nouveau_CI.setContent('<h2 class="titre_liste">'+_("Nouveau centre d'intérêt")+'</h2>');
					...
					newDomaineForm.addInput(_("Nom"),"text","nom");
					newDomaineForm.addInput(_("Couleur"),"color","couleur");
					newDomaineForm.addInput(_("Ajouter"),"submit","ajouter");
	...
	partieD.setWidth(70);
		...
		content_titre_users.setContent("<h2>"+_("Utilisateurs")+"</h2>");
		...
		content_titre_liste_users.setContent('<div class="col_nom">'+_("Nom")+'</div><div class="col_mail">'+_("Email")+'</div><div class="col_tel">'+_("Téléphone")+'</div><div class="col_mod"></div>');
		...
		content_liste_users.setGraphicalElement(liste_users);
			...
			popup_modif_user.setHeight('50%');
				...
				var content_modif_user = popup_modif_user.newVerticalLayout();
					...
					titre_popup_modif_user.setContent('<h2 class="titre_liste">'+_("Modifier Utilisateur")+'</h2>');
					...
					liste_infos_user.getCoupler().updateHandler(function(datas){
						...
						// Creation des items de la liste
						var item = new GraphicalEditInput();
						item.setNameField('<span class="gras_champs_contact">'+_("Nom")+'</span>');
			...
			popup_sup_user.setHeight('100px');
				...
				var content_sup_user = popup_sup_user.newVerticalLayout();
					...
					titre_popup_sup_user.setContent('<h2 class="titre_liste">'+_("Supprimer Utilisateur")+'</h2>');
					
					// Message de confirmation
					var msg_conf_sup_user = content_sup_user.newVerticalLayout();
					msg_conf_sup_user.addCssClass("msg_conf_sup_user");
					msg_conf_sup_user.setContent('<p>'+_("Êtes-vous sûr de vouloir supprimer l'utilisateur ?")+'</p>');
					...
					'<p>'+
					'<input type="button" value="'+_("Oui")+'" class="hidePopup" popup="popup_sup_user" onclick="remove_user_param()" />'+
					'<input type="button" value="'+_("Non")+'" class="hidePopup" popup="popup_sup_user" onclick="GraphicalPopup.hidePopup('+popup_sup_user.getPopupIndex()+');" />'+
					'</p>'
					);
		...
		options_liste_users.setContent('<ul>'+
										'<li id="ajouter_user" class="bouton_option showPopup" popup="popup_new_user"><a href="#">'+_("Nouvel utilisateur")+'</a></li>'+
										'</ul>');
		...
		popup_new_user.setHeight('420px');
			...
			var content_new_user = popup_new_user.newVerticalLayout();
				...
				titre_popup_new_user.setContent('<h2 class="titre_liste">'+_("Nouvel utilisateur")+'</h2>');
				...
				newUserForm.addInput(_("Nom"),"text","nom");
				newUserForm.addInput(_("Prenom"),"text","prenom");
				newUserForm.addInput(_("Statut"),"text","statut");
				newUserForm.addInput(_("Telephone"),"text","tel");
				newUserForm.addInput(_("Fax"),"text","fax");
				newUserForm.addInput(_("Login"),"text","utilisateur");
				newUserForm.addInput(_("Mot de passe"), "password", "password");
				newUserForm.addInput(_("Email"),"text","email");
				newUserForm.addInputWithValue(_("Admin"),"radio","rank","0");
				newUserForm.addInputWithValue(_("Utilisateur"),"radio","rank","1");
				newUserForm.addInputWithValue(_("Client"),"radio","rank","2");
				newUserForm.addInput(_("Ajouter"),"submit","submit");
